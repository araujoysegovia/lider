...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'hwi_oauth.resource_ownermap.admin_area' => 'getHwiOauth_ResourceOwnermap_AdminAreaService',
        ...
        $this->aliases = array(
            ...
            'hwi_oauth.user.provider.entity.admin_area' => 'my_user_provider',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/html/lider/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/html/lider/app/cache/prod/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_41f1a81ca5660ea40f014c802f8485b1c1316a880200288123888a17203731ac');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_41f1a81ca5660ea40f014c802f8485b1c1316a880200288123888a17203731ac');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_41f1a81ca5660ea40f014c802f8485b1c1316a880200288123888a17203731ac');
        ...
        $e->setProxyDir('/var/www/html/lider/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getHwiOauth_ResourceOwner_GoogleService()
    {
        ...
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($a, $this->get('security.http_utils'), array('client_id' => '288359316941-s2dfput5g4q4lrngm51l3njvfa5r1mae.apps.googleusercontent.com', 'client_secret' => 'a752b6be598c1b56bc3e7650b898cbfb1d95fed9', 'scope' => 'https://www.googleapis.com/auth/userinfo.email', 'paths' => array(), 'options' => array()), 'google', new \HWI\Bundle\OAuthBundle\OAuth\RequestDataStorage\SessionStorage($this->get('session')));
    }

    /**
     * Gets the 'hwi_oauth.resource_ownermap.admin_area' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getHwiOauth_ResourceOwnermap_AdminAreaService()
    {
        $this->services['hwi_oauth.resource_ownermap.admin_area'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'google'), array('google' => '/admin/login-check/google'));
    ...
    protected function getHwiOauth_Security_OauthUtilsService()
    {
        ...
        $instance->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.admin_area'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/html/lider/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminAreaService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, 'admin_index_page'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'admin_logout'));
        $h->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $i = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => '/admin/', 'always_use_default_target_path' => true, 'use_referer' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'));
        $i->setProviderKey('admin_area');

        $j = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'admin_area', $i, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/admin/', 'failure_forward' => true, 'failure_path' => 'admin_check_failure', 'failure_path_parameter' => '_failure_path'), $a), array('use_forward' => false, 'check_path' => '/admin/login-check', 'require_previous_session' => true), $a, $c);
        $j->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.admin_area'));
        $j->setCheckPaths(array(0 => '/admin/login-check/google'));

        return $this->services['security.firewall.map.context.admin_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Lider\\Bundle\\LiderBundle\\Entity\\Player', 'email', NULL), 1 => $this->get('my_user_provider')), 'admin_area', $a, $c), 2 => $h, 3 => $j, 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '53d7bc70320fc', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $d, 'admin_area', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/admin/', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/html/lider/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/lider/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/html/lider/app/cache/prod/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/html/lider/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/lider/vendor/hwi/oauth-bundle/HWI/Bundle/OAuthBundle/Resources/views', 'HWIOAuth');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/html/lider/app/../web', true);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('my_user_provider'), $this->get('hwi_oauth.resource_ownermap.admin_area'), $this->get('hwi_oauth.user_checker')), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('53d7bc70320fc')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/html/lider/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/html/lider/app/cache/prod',
            ...
            'debug.container.dump' => '/var/www/html/lider/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/html/lider/app/cache/prod/sessions',
            ...
            'router.resource' => '/var/www/html/lider/app/config/routing.yml',
            ...
            'hwi_oauth.resource_ownermap.configured.admin_area' => array(
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/html/lider/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/html/lider/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/html/lider/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/lider/app/cache/prod/doctrine/orm/Proxies',
            ...
            'hwi_oauth.firewall_name' => 'admin_area',
