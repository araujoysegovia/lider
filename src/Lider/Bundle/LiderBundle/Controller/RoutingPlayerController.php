...
class RoutingPlayerController extends Controller
{
    ...
    /**   
     * @Template("LiderBundle:LiderPlayer:index.html.twig")
     */
    public function loginPageAction(Request $request)
    {
        ...
        //return $this->render('LiderBundle:LiderPlayer:index.html.twig');
    }
    ...
    /**   
     * @Template("LiderBundle:LiderPlayer:home.html.twig")
     */
