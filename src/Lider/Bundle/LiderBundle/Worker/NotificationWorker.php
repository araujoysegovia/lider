...
//         $to = $this->getEmailFromTeamId($team->getId());
            ...
            $send = $notificationService->sendEmail($data['subject'], $this->from, "eescallon@araujoysegovia.com", null, $data['viewName'], $data['content']);
            echo "\n\nMensaje Enviado a: ";
            print_r($data['to']);
...
//                 $to = $this->getEmailFromTeamId($team->getId());
    ...
    public function adminNotificationDuels(\GearmanJob $job){
        ...
        if($admins)
        {
            ...
            try{
                $send = $notificationService->sendEmail($subject, $this->from, "eescallon@araujoysegovia.com", null, $template, $data['content']);
                echo "Mensaje Enviado al administrador";
            }catch(\Exception $e){
                echo $e->getMessage();
            }
